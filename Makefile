...
#### LIST ####
LST_SRC := minishell.c 
LST_SRC_BNS := built_in_bonus.c calloc_bonus.c cd_bonus.c echo_bonus.c env_bonus.c env_check_bonus.c env_init_bonus.c export_bonus.c free_bonus.c getenv_bonus.c isalnum_bonus.c linklist_env2_bonus.c linklist_env_bonus.c minishell_bonus.c moulinator_bonus.c pwd_bonus.c split_bonus.c split_utils_bonus.c strcmp_bonus.c strdup_bonus.c strjoin_bonus.c strlen_bonus.c unset_bonus.c valid_env_var_name_bonus.c 
LST_OBJ := $(LST_SRC:.c=.o)
