...
#    Updated: 2022/07/12 13:10:49 by jalamell         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #

#### LIST ####
LST_SRC := minishell.c 
LST_SRC_BNS := built_in_bonus.c calloc_bonus.c cd_bonus.c echo_bonus.c env_bonus.c env_check_bonus.c env_init_bonus.c executor_bonus.c expand_line_bonus.c export_bonus.c free_bonus.c getenv_bonus.c is_in_charset_bonus.c isalnum_bonus.c linklist_env2_bonus.c linklist_env_bonus.c max_min_bonus.c minishell_bonus.c moulinator_bonus.c parsing_bonus.c pipex_bonus.c precall_cd_bonus.c precall_echo_bonus.c precall_exit_bonus.c precall_export_bonus.c precall_unset_bonus.c pwd_bonus.c reverse_env_bonus.c split_bonus.c strcmp_bonus.c strdup_bonus.c strjoin_bonus.c strlen_bonus.c strtrim_bonus.c substr_bonus.c super_split_bonus.c termios_stuff_bonus.c unset_bonus.c valid_env_var_name_bonus.c 
LST_OBJ := $(LST_SRC:.c=.o)
